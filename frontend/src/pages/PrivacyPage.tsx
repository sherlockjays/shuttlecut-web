    ...
    <div className="min-h-screen bg-gray-900 text-gray-300 py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-sm leading-relaxed mb-8">
          ShuttleCut(이하 "서비스") 운영자는 개인정보보호법 등 관련 법률에 따라 이용자의 개인정보를
          보호하고, 이와 관련한 고충을 신속하게 처리하기 위해 다음과 같이 개인정보처리방침을
          수립·공개합니다.
        </p>
        ...
        <section className="mb-8">
          ...
          <div className="text-sm leading-relaxed space-y-3">
            <p>
              개인정보는 수집 목적이 달성된 후 지체 없이 삭제합니다. 단, 다음의 경우에는 해당 기간
              동안 보존합니다.
            </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed">
            운영자는 이용자의 개인정보를 원칙적으로 제3자에게 제공하지 않습니다. 단, 이용자의 동의가
            있거나 법령에 의한 경우에는 예외로 합니다.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed">
            서비스는 로그인 상태 유지를 위해 브라우저 로컬 스토리지에 JWT 인증 토큰을 저장합니다.
            이는 쿠키와 유사한 방식으로 작동하며, 브라우저의 데이터 삭제 기능으로 제거할 수
            있습니다.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-gray-800 rounded-lg p-4 text-sm space-y-1">
            <p className="text-gray-300">
              이메일:{" "}
              <a href="mailto:wjdwoghk16@gmail.com" className="text-blue-400 hover:underline">
                wjdwoghk16@gmail.com
              </a>
            </p>
            <p className="text-gray-500 text-xs mt-2">
              개인정보 관련 문의는 위 이메일로 접수해주세요. 영업일 기준 3일 이내 답변합니다.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-gray-400">
            개인정보 침해로 인한 구제를 받기 위해 개인정보분쟁조정위원회, 한국인터넷진흥원
            개인정보침해신고센터 등에 분쟁해결이나 상담을 신청할 수 있습니다.
          </p>
